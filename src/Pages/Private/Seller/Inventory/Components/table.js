...
export const InventoryTable = () => {
  ...
  const data = [
    {
      item: {
        image:
          "https://plus.unsplash.com/premium_photo-1669234310386-4eab25e036a0?q=80&w=3387&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  return (
    <Container>
      <SellerTable data={data} columns={columns} />
    </Container>
  );
};
